...
#define TD_USER_DEFAULTS_KEY_CUSTOM_EVENTS_BLOCKED @"TDCustomEventsBlocked"
#define TD_USER_DEFAULTS_KEY_APP_LIFECYCLE_EVENTS_BLOCKED @"TDAppLifecycleEventsBlocked"
