...
```
pod 'TreasureData-iOS-SDK', '= 0.2.0
```
...
Download [TreasureData.framework](http://cdn.treasuredata.com/sdk/ios/0.2.0/TreasureData-iOS-SDK.framework.zip) and add it and `libz` library into your project.
