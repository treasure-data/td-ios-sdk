...
```
pod 'TreasureData-iOS-SDK', '= 0.1.13'
```
...
Download [TreasureData.framework](http://cdn.treasuredata.com/sdk/ios/0.1.13/TreasureData-iOS-SDK.framework.zip) and add it and `libz` library into your project.
