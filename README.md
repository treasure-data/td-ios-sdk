...
```
pod 'TreasureData-iOS-SDK', '= 0.7.0'
```
...
Download [TreasureData.framework](http://cdn.treasuredata.com/sdk/ios/0.7.0/TreasureData-iOS-SDK.framework.zip) and add it and `libz` library into your project.
